(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["FlexReactForm"] = factory(require("react"), require("react-dom"));
	else
		root["FlexReactForm"] = factory(root["react"], root["react-dom"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.FlexSwitch = exports.FlexDropdown = exports.FlexReactModal = exports.FlexButton = exports.FlexInput = undefined;
	
	var _FlexInput2 = __webpack_require__(14);
	
	var _FlexInput3 = _interopRequireDefault(_FlexInput2);
	
	var _FlexButton2 = __webpack_require__(29);
	
	var _FlexButton3 = _interopRequireDefault(_FlexButton2);
	
	var _FlexReactModal2 = __webpack_require__(30);
	
	var _FlexReactModal3 = _interopRequireDefault(_FlexReactModal2);
	
	var _FlexDropdown2 = __webpack_require__(35);
	
	var _FlexDropdown3 = _interopRequireDefault(_FlexDropdown2);
	
	var _FlexSwitch2 = __webpack_require__(98);
	
	var _FlexSwitch3 = _interopRequireDefault(_FlexSwitch2);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.FlexInput = _FlexInput3.default; /**
	                                          * @copyright 2016-present
	                                          */
	
	exports.FlexButton = _FlexButton3.default;
	exports.FlexReactModal = _FlexReactModal3.default;
	exports.FlexDropdown = _FlexDropdown3.default;
	exports.FlexSwitch = _FlexSwitch3.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FlexInput = function (_Component) {
	  ...
	  _createClass(FlexInput, [{
	    ...
	    value: function render() {
	      ...
	      var readMode = _props2.readMode;
	      var
	
	      // control on addon
	      hasAddon = _props2.hasAddon;
	      var provider = _props2.provider;
	      var addonType = _props2.addonType;
	      var iconClass = _props2.iconClass;
	      var iconHidden = _props2.iconHidden;
	      var addonContent = _props2.addonContent;
	      ...
	      switch (readMode) {
	        case 'read-only':
	          inputClass = (0, _classnames2.default)(inputClass, { "read-only": true });
	          break;
	        case 'forbidden':
	          inputClass = (0, _classnames2.default)(inputClass, { forbidden: true });
	          break;
	      }
	
	      var buttonAddonClass = function buttonAddonClass() {
	        if (hasToggle) {
	          ...
	          switch (addonType) {
	            case "text":
	              return _react2.default.createElement(
	                'span',
	                { className: 'flex-input-group-addon' },
	                addonContent
	              );
	            case "icon":
	              if (provider === 'font-awesome') {
	                return _react2.default.createElement(
	                  'span',
	                  { className: 'flex-input-group-addon' },
	                  _react2.default.createElement('i', { className: iconClass, 'aria-hidden': iconHidden })
	                );
	              } else {
	                return null;
	              }
	            case "button":
	              return _react2.default.createElement(
	                'div',
	                { className: 'flex-input-group-btn' },
	                _react2.default.createElement('button', { type: 'button', className: buttonAddonClass })
	              );
	            default:
	              return null;
	          }
	      ...
	      var renderInputClass = function renderInputClass() {
	        if (hasAddon) {
	...
	FlexInput.propTypes = {
	  ...
	  refer: _react.PropTypes.string,
	  readMode: _react.PropTypes.string
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModalHeader = __webpack_require__(31);
	
	var _ModalHeader2 = _interopRequireDefault(_ModalHeader);
	
	var _ModalBody = __webpack_require__(32);
	
	var _ModalBody2 = _interopRequireDefault(_ModalBody);
	
	var _ModalFooter = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FlexInput = __webpack_require__(14);
	
	var _FlexInput2 = _interopRequireDefault(_FlexInput);
	
	var _FlexButton = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FlexSeperator = __webpack_require__(97);
	
	var _FlexSeperator2 = _interopRequireDefault(_FlexSeperator);
	...
	var FlexDropdown = function (_Component) {
	  _inherits(FlexDropdown, _Component);
	
	  function FlexDropdown(props) {
	    _classCallCheck(this, FlexDropdown);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FlexDropdown).call(this, props));
	  ...
	  _createClass(FlexDropdown, [{
	    ...
	    value: function render() {
	      var _props = this.props;
	      var dropdownContent = _props.dropdownContent;
	      var dropdownGroup = _props.dropdownGroup;
	      var hasDropdownMenu = _props.hasDropdownMenu;
	
	
	      var dropdownMenuClass = (0, _classnames2.default)('flex-dropdown-menu', { open: this.state.display });
	      ...
	      var renderDropdownMenu = function renderDropdownMenu() {
	        ...
	        if (hasDropdownMenu) {
	          var _ret = function () {
	            var groupLength = dropdownGroup.length;
	
	            return {
	              v: _react2.default.createElement(
	                'div',
	                { className: dropdownMenuClass },
	                dropdownGroup.map(function (group, key) {
	                  if (key < groupLength - 1) {
	                    return _react2.default.createElement('div', { key: key }, [renderGroup(group), _react2.default.createElement(_FlexSeperator2.default, null)]);
	                  } else {
	                    return _react2.default.createElement('div', { key: key }, [renderGroup(group)]);
	                  }
	                })
	              )
	            };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FlexSeperator = function (_Component) {
	  _inherits(FlexSeperator, _Component);
	
	  function FlexSeperator(props) {
	    _classCallCheck(this, FlexSeperator);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(FlexSeperator).call(this, props));
	  }
	
	  _createClass(FlexSeperator, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement("div", { className: "flex-seperator" });
	    }
	  }]);
	
	  return FlexSeperator;
	}(_react.Component);
	
	exports.default = FlexSeperator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FlexSwtich = function (_Component) {
	  _inherits(FlexSwtich, _Component);
	
	  function FlexSwtich(props) {
	    _classCallCheck(this, FlexSwtich);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FlexSwtich).call(this, props));
	  ...
	  _createClass(FlexSwtich, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var switchClassName = (0, _classnames2.default)('flex-switch', {
	        checked: this.state.checked,
	        disabled: this.state.disabled
	      });
	
	      var handleClick = this.state.disabled ? function () {} : this.handleClick;
...
;
//# sourceMappingURL=FlexReactForm.js.map